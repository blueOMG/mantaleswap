...
import { TokenAmount, Token, ChainId, Percent, JSBI } from 'mantleswapsdk'
...
describe('utils', () => {
  describe('#getEtherscanLink', () => {
    ...
    it('enum', () => {
      expect(getEtherscanLink(ChainId.MAINNET, 'abc', 'address')).toEqual('https://rinkeby.etherscan.io/address/abc')
    })
  })
